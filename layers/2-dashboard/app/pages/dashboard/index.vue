...
definePageMeta({
  ...
  middleware: ['role'],
  role: 'admin',
  dashboardEyebrow: 'Acessos',
  dashboardTitle: 'Quem pode entrar'
})
...
<template>
  <div class="space-y-6">
    ...
    <section
      ...
      class="rounded-2xl border border-stroke/80 bg-surface/75 p-4 shadow-[0_20px_40px_-34px_rgba(41,67,101,0.7)]"
    >
      ...
      <ul class="mt-3 space-y-2 text-sm">
        ...
        >
          ...
          <button
            type="button"
            class="rounded-full border border-rose-500/30 bg-rose-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-rose-500 transition-colors hover:bg-rose-500/20"
