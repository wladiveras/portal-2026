...
<template>
  <div class="flex flex-col items-end gap-1">
    <button
      type="button"
      class="gradient-border inline-flex items-center gap-2 rounded-full border border-stroke bg-surface/95 px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-text-primary transition-colors hover:bg-bg disabled:opacity-40"
