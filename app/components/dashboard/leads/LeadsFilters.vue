  ...
  <section class="flex flex-col gap-3 rounded-2xl border border-stroke bg-surface/80 p-4 md:flex-row md:items-end md:gap-4">
    ...
    <div class="flex flex-col gap-1">
      ...
      <input
        ...
        type="date"
        class="rounded-full border border-stroke bg-bg px-3 py-1.5 text-sm text-text-primary"
      />
    </div>
    <div class="flex flex-col gap-1">
    ...
    <button
      type="button"
      class="self-start rounded-full border border-stroke bg-bg px-3 py-1.5 text-xs text-muted transition-colors hover:text-text-primary md:self-end"
      @click="reset"
    >
      Limpar
    </button>
