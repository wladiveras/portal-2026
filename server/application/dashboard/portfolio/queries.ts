...
/** Static landing portfolio payload (no I/O). Future: CMS/DB behind same function signature.
 * Editorial voice: `docs/copy-voice-prompt.md`. Contract tests: `tests/unit/server/portfolio-payload.contract.spec.ts`. */
export function qryPortfolioPayload(): PortfolioData {
  return {
